-- ============================================================
-- AGREGAR COLUMNA DE AJUSTE A COMPRAS_INVENTARIO Y ACTUALIZAR RPC
-- ============================================================

-- 1. Agregar la columna ajuste a compras_inventario
alter table compras_inventario 
add column ajuste numeric(12,3) not null default 0;

-- 2. Actualizar la función registrar_compra para soportar p_ajuste
...
begin
  ...
  insert into compras_inventario (proveedor_id, fecha, metodo_pago, notas, total, ajuste)
  values (p_proveedor_id, p_fecha, p_metodo_pago, p_notas, 0, coalesce(p_ajuste, 0))
